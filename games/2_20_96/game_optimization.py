        ...
        self.game_config.opt_params = {
            "base": {
                "conditions": {
                    ...
                    #).return_dict(),
                    "basegame": ConstructConditions(hr=3.5, rtp=0.97).return_dict(),
                },
            ...
            "bonus2": {
                ...
                "scaling": ConstructScaling(
                    [
                #        {"criteria": "freegame", "scale_factor": 0.9, "win_range": (50, 100), "probability": 1.0},
                #        {"criteria": "freegame", "scale_factor": 0.7, "win_range": (1000, 2500), "probability": 1.0},
                #        {"criteria": "freegame", "scale_factor": 1.3, "win_range": (3000, 5000), "probability": 1.0},
                    ]
                ).return_dict(),
                "parameters": ConstructParameters(
                    num_show=5000,
